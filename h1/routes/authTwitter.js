...
const twitterConfig = require('../config/Twitter_config');
...
const passportOptions = {
    consumerKey: twitterConfig.twitterAuth.CONSUMER_KEY,
    consumerSecret: twitterConfig.twitterAuth.CONSUMER_SECRET,
    callbackURL: twitterConfig.twitterAuth.CALLBACK_URL
}
